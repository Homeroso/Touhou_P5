class Enemy {
    ...
    shoot() {
        if (this.shootingPattern === 'circular') {
            ...
            enemyBullets.push(new EnemyBullet(this.x, this.y, null, enemyBulletImage));
        }
    }
    ...
    shootCircularPattern() {
        ...
        for (let i = 0; i < numBullets; i++) {
            ...
            enemyBullets.push(new EnemyBullet(bulletX, bulletY, angle, enemyBulletImage));
        }
    }
    ...
    shootLinePattern() {
        ...
        for (let i = 0; i < numBullets; i++) {
            ...
            enemyBullets.push(new EnemyBullet(this.x + offsetX, this.y + offsetY, baseAngle, enemyBulletImage));
        }
    }
